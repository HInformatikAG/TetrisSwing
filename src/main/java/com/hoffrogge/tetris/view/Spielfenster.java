...
public class Spielfenster extends JFrame {
    ...
    public Spielfenster(Spielfeld spielfeld, Vorschau vorschau) {
        ...
        lblPauseMitP.setBounds(TetrisKonstanten.SPIELFELD_BREITE + TetrisKonstanten.ABSTAND * 2,
                TetrisKonstanten.SPIELFELD_HOEHE - TetrisKonstanten.ABSTAND, TetrisKonstanten.VORSCHAU_BREITE,
        ...
        // sollte doch eher in den entsprechenden Klassen geschehen und nicht an dieser Stelle hier,
        // aber solange Spielfeld und Vorschau nicht sichtbar sind, kann man createBufferStrategy nicht aufrufen
